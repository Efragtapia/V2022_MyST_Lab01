...
def f_descriptive_ob(data_ob:dict) -> dict:
    ...
    r_data = {'median_ts_ob': ob_m1, 'Spread': ob_m2, 'Midprice': ob_m3, 'No_price_levels': ob_m4, 'Bid_Volume': ob_m5, 'Ask_Volume': ob_m6, 'Total_Volume': ob_m7, 'Imbalance': ob_m8, 'W-Midprice': ob_m9, 'V-WAP': vwap}
